...
![The space covered by an agent who can take as many as 5 steps is much greater than the space covered by an agent who can only take 1. The grid is toridal.](media/compare_agent_step_sizes.png){width=90% #fig-compare_agent_step_sizes}
