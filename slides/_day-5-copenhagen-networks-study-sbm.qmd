...
::: {.column width="50%"}
```{python}
state = gt.minimize_blockmodel_dl(g_bt)

synthetic_g_bt = gt.generate_sbm(
  state.b.a,
  state.get_matrix(),
  directed=g_bt.is_directed()
)
...
::: {.fragment}
That's it for the first part! 😎 We'll set this simulated network aside for now, but you'll see it again soon.
