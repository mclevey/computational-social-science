...
:::: {.columns}
::: {.column width="65%"}
We'll run two models here to reproduce @fig-sir_compare. Here's **Model 1**!
...
$\longleftarrow$<br>@fig-sir_compare from earlier in the lecture. Proportion of infected people in a population over time from two SIR simulations with different transmissability rates. Not (yet) shown: proportion of susceptible and recovered.
:::
::::
...
:::: {.columns}
::: {.column width="55%"}
There is much more we could do here, but let's move on to some different examples.
:::
::: {.column width="45%"}
:::
::::
