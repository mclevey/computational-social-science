...
### pitfalls and other problems <br>with [heuristic]{.kn-pink} network analysis

<br>

🔴 community detection via modularity-maximization [(Louvain, Leiden)]{.nord-light}<br>
🔴 implicit model-based [(force-directed)]{.nord-light} visualization
...
- simplify network [(detect subgroup structure, compute centrality)]{.nord-light}
...
#### Common pitfalls and other problems
...
- using heuristic approaches [(esp. modularity-maximization)]{.nord-light} to simplify and partition networks into subgroups
- using network visualizations [(esp. force-directed)]{.nord-light} for insight into network structure without sufficient consideration and criticism of implicit models
:::
::::
...
[There have been some improvements to modularity-maximization approaches [[e.g., @traag2019louvain]]{.nord-light}, but these only go so far. There are **fundamental problems** with the modularity-maximization idea.]{.fragment}
:::
::: {.column width=45%}
:::
::::
