...
::: {.column width="70%"}
How do opinions form, change, and reach consensus or polarization in social systems?

<br>

[Bounded Confidence Models]{.large-text .kn-pink}

BCMs simulate opinion evolution in a continuous opinion space.

Key idea: People interact and influence each other if their opinions are within a certain threshold (ε).
:::
::::
...
class BCMAgent(Agent):
    def __init__(self, unique_id, model, epsilon, max_agent_step_size=1):
        ...
        self.epsilon = epsilon  # Confidence bound (ε)
...
![Caption](media/bounded-confidence-opinion-distribution-evolution.png){width="75%" #fig-bcmevo}
...
![Caption](media/bounded_confidence_epsilon_one_run.png){width="75%" #fig-bounded_confidence_epsilon_one_run}
...
![Caption](media/epsilon_comparison_one_run.png){width="100%" #fig-epsilon_comparison_one_run}
