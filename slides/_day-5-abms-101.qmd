...
## Modelling Complex Systems: Equation-based and Agent-based Approaches
...
ABMs have been central to computational social science from the start.
...
:::: {.columns}
::: {.column width="25%"}
SIR Models, Classic vs. Agent-based
:::
...
:::: {.columns}
::: {.column width="55%"}
![The space covered by an agent who can take as many as 5 steps is much greater than the space covered by an agent who can only take 1.](media/compare_agent_step_sizes.png){width=75% #fig-compare_agent_step_sizes}
:::
...
::: {.column width="40%"}
The grid is **toroidal**, which means all four edges wrap to each other.
:::
::::
...
## Zooming Back Out: The Big Picture

[[@railsback2019agent]]{.nord-footer}

### What are models?

The agent-based perspective offers a different way to model and learn about complex systems.
...
<!-- - With reference to the SIR example -->
...
::: {.column width="65%"}
1. patterns for model structure
