...
::: {.column width="50%"}
![Subgroup membership assigned using a Nested Stochastic Blockmodel.<br>Which is the problem? The visualization model, or the SBM? [(It's the visualization...)]{.nord-light}](media/divided_they_blog_sbm.png){width=90%  #fig-divided_they_blog_sbm}
:::
::::
...
:::: {.columns}
::: {.column width="65%"}
![Things look *very* different if we add attractive forces between nodes placed in the same group rather than just between adjacent nodes. This is still force directed, but this time the **model has been explicated, criticized, and refined** for the task at hand.](media/divided_they_blog_lay.png){width=100% #fig-divided_they_blog_lay}
:::
...
[We are not limited to force directed visualizations, of course.]{.nord-light}

### Hierarchical Edge Bundling

![Another view of subgroup structure in the political blogs network.](media/divided_they_blog_chordal.png){width=30% #fig-divided_they_blog_chordal}
