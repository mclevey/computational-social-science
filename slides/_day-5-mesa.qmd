...
axs[0].set_yticks(np.arange(0, 21, 2))  # Set y-axis ticks to every 2nd number
axs[0].set_xticks(np.arange(0, 21, 2))  # Set x-axis ticks to every 2nd number
...
axs[1].set_ylim(-0.5, 20.5)
axs[1].set_yticks(np.arange(0, 21, 2))  # Set y-axis ticks to every 2nd number
axs[1].set_xticks(np.arange(0, 21, 2))  # Set x-axis ticks to every 2nd number
